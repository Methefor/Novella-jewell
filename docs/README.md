...
| `CURRENT_STATE.md`  | Tamamlanan işler, açık sorunlar, satış engelleri ve sıradaki doğrulanmış adım.                                      | Her yayın hazırlığı ve büyük doğrulama turunda.                            |
| `WORKLOG.md`        | Git geçmişine dayalı geliştirme özeti ve çalıştırılmış test sonuçları.                                               | Önemli geliştirme veya test turundan sonra.                                |
| `LAUNCH_CHECKLIST.md` | Kod, production ve operasyon kanıtlarına dayalı lansman kontrol listesi.                                           | Lansman öncesi her doğrulama turunda.                                      |
...
2. **Şema veya API sorusu** varsa `@docs/ARCHITECTURE.md` veya `@docs/API.md` referans alınır.
