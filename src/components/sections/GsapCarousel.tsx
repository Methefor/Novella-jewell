...
const slides = [
  {
    title: 'Bilezik',
    img1: '/media/bileklik/bileklik-1.jpg',
    img2: '/media/bileklik/bileklik-6.jpg',
    dark: true,
  },
  {
    title: 'Küpe',
    img1: '/media/kupe/kupe-2.jpg',
    img2: '/media/kupe/kupe-5.jpg',
    dark: false,
  },
  {
    title: 'Yüzük',
    img1: '/media/yuzuk/yuzuk-3.jpg',
    img2: '/media/yuzuk/yuzuk-7.jpg',
    dark: true,
  },
  {
    title: 'Bilezik',
    img1: '/media/bileklik/bileklik-10.jpg',
    img2: '/media/bileklik/bileklik-15.jpg',
    dark: false,
  },
  {
    title: 'Küpe',
    img1: '/media/kupe/kupe-6.jpg',
    img2: '/media/kupe/kupe-9.jpg',
    dark: true,
  },
  {
    title: 'Yüzük',
    img1: '/media/yuzuk/yuzuk-10.jpg',
    img2: '/media/yuzuk/yuzuk-14.jpg',
    dark: false,
  },
];
