...
export default function FavorilerClient() {
  ...
  const emptyMessage = 'Favorileriniz Boş';
  const emptyDescription =
    'Henüz favori ürününüz yok. Beğendiğiniz ürünleri favorilere ekleyerek daha sonra kolayca bulabilirsiniz.';
  const exploreButton = 'Ürünleri Keşfet';
  const pageTitle = 'Favorilerim';
  const productCount = `${items.length} ürün`;
  const clearButton = 'Tümünü Temizle';
    ...
    return (
      <div className="min-h-screen bg-cream flex items-center justify-center px-4">
        <div className="text-center max-w-md">
          ...
          <p className="text-black/60 mb-6">{emptyDescription}</p>
          <Link
            href="/collections"
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-black/60">{productCount}</p>
          </div>
